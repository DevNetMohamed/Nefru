...
export const env = {
  ...
  // mongoUri: process.env.MONGODB_URI || "mongodb+srv://NEFRU:NEFRUow1dcs8D7YCVaiOi@nefru.vxsueiy.mongodb.net/?appName=NEFRU",
  mongoUri: "mongodb://localhost:27017/nefru" || process.env.MONGODB_URI,
